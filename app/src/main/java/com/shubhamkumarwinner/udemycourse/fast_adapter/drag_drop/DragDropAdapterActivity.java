package com.shubhamkumarwinner.udemycourse.fast_adapter.drag_drop;
...
import com.shubhamkumarwinner.udemycourse.fast_adapter.fast_scroll.FastScrollIndicatorAdapter;
...
public class DragDropAdapterActivity extends AppCompatActivity implements ItemTouchCallback, ItemFilterListener<SimpleItem> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Drag and drop list");
    ...
    public void itemsFiltered(@Nullable CharSequence constraint, @Nullable List<SimpleItem> results) {
        Toast.makeText(DragDropAdapterActivity.this, "filtered items count: " + itemAdapter.getAdapterItemCount(), Toast.LENGTH_SHORT).show();
    }
