...
public class SwipeListAdapterActivity extends AppCompatActivity implements ItemTouchCallback, SimpleSwipeCallback.ItemSwipeCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Swipe list");
        ...
        fastItemAdapter.getItemFilter().withFilterPredicate(new IItemAdapter.Predicate<SwipeableItem>() {
            @Override
            public boolean filter(@NonNull SwipeableItem item, CharSequence constraint) {
    ...
    public void itemSwiped(int position, int direction) {
        ...
        final View rv = findViewById(R.id.simple_recycler_view);
